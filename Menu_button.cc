...
Int_button::Int_button(sf::Vector2f pos, sf::Sprite s0, sf::Sprite s1, sf::Sprite s2, sf::Sprite s3, sf::Sprite s4 , sf::Sprite sbg )
  : sprite0{s0}, sprite1{s1}, sprite2{s2}, sprite3{s3}, sprite4{s4}, sprite_background{sbg} , value{0}
 {
  ...
  shape_sprite1.setSize(sf::Vector2f(20, 20));
  ...
  shape_sprite2.setSize(sf::Vector2f(20, 20));
  ...
  shape_sprite3.setSize(sf::Vector2f(20, 20));
  ...
  shape_sprite4.setSize(sf::Vector2f(20, 20));
