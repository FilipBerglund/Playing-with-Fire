...
test: $(BIN_NECESSARY) test_main.o test_gameobj.o player_test.o
	$(CCC) $(CFLAGS)  $(BIN_NECESSARY) test_main.o test_gameobj.o player_test.o -lsfml-graphics -lsfml-window -lsfml-system
