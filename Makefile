...
test: $(BIN_NECESSARY) test_main.o test_gameobj.o fire_test.o player_test.o bomb_test.o
	$(CCC) $(CFLAGS)  $(BIN_NECESSARY) test_main.o fire_test.o test_gameobj.o player_test.o bomb_test.o -lsfml-graphics -lsfml-window -lsfml-system
