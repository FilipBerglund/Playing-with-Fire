...
TEST = test_main.cc fire_test.cc test_gameobj.cc player_test.cc bomb_test.cc
TEST_NECESSARY := $(TEST:.cc=.o)
...
test: $(BIN_NECESSARY) $(TEST_NECESSARY)
	$(CCC) $(CFLAGS)  $(BIN_NECESSARY) $(TEST_NECESSARY) -lsfml-graphics -lsfml-window -lsfml-system
